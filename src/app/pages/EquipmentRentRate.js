...
const columns = [
    ...
    { 'value': 'rentRate', 'title': 'Rent' },
    { 'value': 'action', 'title': 'Action' },

];

const url = process.env.REACT_APP_API_URL + "equipment/equipment_rentrate_list";

class EquipmentRentRate extends Component {
    constructor(props) {
        super(props);
    ...
    save = value => evt => {
        var obj = {
            equipmentRentRateId: value.equipmentRentRateId,
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You want to update this rent rate',
            icon: 'warning',
            ...
            if (result.value) {
                ...
                fetch(process.env.REACT_APP_API_URL + "equipment/equipment_rent_setup", requestOptions)
                    .then((resp) => {
                        return resp.json()
                    })
                    .then((resp) => {
                        ...
                        if (resp.success === true) {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
                                text: 'Rent Rate Updated successfully',
                            })
                            this.fetchEntities();
                        }
                        else {
        ...
        if (this.state.entities.data.length) {
            return this.state.entities.data.map((value, key) => {
                return <tr key={key} >
                    ...
                    <td><input className="form-control form-control-sm" type="text" value={value.rentRate || ""} onChange={this.onRentChange(key)} /></td>
        ...
        return (
            <div className="card card-custom">
                ...
                <div className="card-header">
                    <h3 className="card-title"><p className="text-primary">Equipment Rent Rate Setup</p></h3>
                </div>
                ...
                <div className="card-body">
                    ...
                    <div className="table-responsive" style={{ 'height': '550px', 'overflow': 'auto' }}>
                        ...
                        {/* <pre>
                            {JSON.stringify(this.state.entities.data, null, 2)}
                        </pre> */}
                    </div>
...
export default EquipmentRentRate;