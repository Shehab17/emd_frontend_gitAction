...
const url = process.env.REACT_APP_API_URL + "maintenance_order/order_completed_dt";

class MaintenanceOrderCompletedDt extends Component {
    constructor(props) {
        super(props);
            ...
            return this.state.entities.data.map((value, key) => {
                return <tr key={value.maintOrderId} >
                    ...
                    <td className="text-center">
                        <Link to={`/maintenance-order-details/${value.maintOrderId}`}>
...
export default MaintenanceOrderCompletedDt;