...
const url = process.env.REACT_APP_API_URL + "maintenance_order/order_ongoing_dt";

class MaintenanceOrderOngoingDt extends Component {
    constructor(props) {
        super(props);
...
export default MaintenanceOrderOngoingDt;