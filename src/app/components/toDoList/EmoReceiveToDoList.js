...
const url = process.env.REACT_APP_API_URL + "emd/emo_receive_to_do_list";

class EmoReceiveToDoList extends Component {
    constructor(props) {
        super(props);
            ...
            return this.state.entities.data.map((value, key) => {
                return <tr key={key} >
                    ...
                    <td className="text-center">
                        <Link to={{pathname:'/emo-receive',info:{ details : JSON.stringify(value)}}}>
                            <Button type="button" className="btn btn-outline-success btn-sm"> <i className="flaticon2-send-1"></i> Emo Receive</Button>
                        </Link>
                    </td>
                </tr>
            })
...
export default EmoReceiveToDoList;