...
const url = process.env.REACT_APP_API_URL + "site_person_dt";

class SitePersonDt extends Component {
	constructor(props) {
		super(props);
	...
	componentDidUpdate(prevProps) {
		if (this.props.addnewSitePerson.id !== prevProps.addnewSitePerson.id) // Check if it's a new user, you can also use some unique property, like the ID  (this.props.user.id !== prevProps.user.id)
		{
