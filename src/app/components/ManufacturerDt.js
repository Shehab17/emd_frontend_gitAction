...
const url = process.env.REACT_APP_API_URL + "manufacturer_dt";

class ManufacturerDt extends Component {
	constructor(props) {
		super(props);
	...
	componentDidUpdate(prevProps) {
		if (this.props.addnewManufacturer.id !== prevProps.addnewManufacturer.id) // Check if it's a new user, you can also use some unique property, like the ID  (this.props.user.id !== prevProps.user.id)
		{
