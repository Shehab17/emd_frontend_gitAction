...
const url = process.env.REACT_APP_API_URL + "billing_parameter_dt";

class BillingParameterDt extends Component {
	constructor(props) {
		super(props);
	...
	componentDidUpdate(prevProps) {
		if (this.props.addnewBillingParameter.id !== prevProps.addnewBillingParameter.id) // Check if it's a new user, you can also use some unique property, like the ID  (this.props.user.id !== prevProps.user.id)
		{
...
export default BillingParameterDt;